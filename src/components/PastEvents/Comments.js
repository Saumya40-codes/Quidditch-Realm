...
const Comments = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await Axios.put(`https://quidditch-realm.vercel.app/events/addComment/${id}`, {
        comment: comment,
  ...
  const handleDeleteComment = async (e, comment_id) => {
    e.preventDefault();
    try {
      const res = await Axios.put(`https://quidditch-realm.vercel.app/events/deleteComment/${id}`, {
  ...
  const handleEdit = async (e) => {
    e.preventDefault();
    try {
        const res = await Axios.put(`https://quidditch-realm.vercel.app/events/editComment/${id}`, {
