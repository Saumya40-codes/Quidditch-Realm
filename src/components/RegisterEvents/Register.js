...
export default function HorizontalLinearStepper() {
  ...
  const handleFormSubmit = async(e) =>{
    ...
    try{
      const res = await Axios.post('https://quidditch-realm.vercel.app/reg/register/events',{
        ...formChange
      })
      .then(async (res)=>{
        setTimeout(()=>{
        ...
        const resp = await Axios.put(`https://quidditch-realm.vercel.app/events/tickets/change/${id}`,{
          ticket : tickets,
